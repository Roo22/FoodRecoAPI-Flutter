...
import 'dart:io';
import 'dart:ui';
import 'package:api/Componant/constants.dart';
import 'package:api/Componant/custom_outline.dart';
...
class _MIModelState extends State<MIModel> {
  ...
  File? img;
  var url = "http://192.168.1.6:5000/predictApi";
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      extendBody: true,
      appBar: AppBar(
        backgroundColor: Constants.kDarkFuchsiaColor,
        title: Text('Foodie Mate'),
      ),
      body: SizedBox(
        height: ScreenHeight,
        width: ScreenWidth,
